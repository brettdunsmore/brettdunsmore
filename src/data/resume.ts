...
export const profileData: ProfileData = {
  ...
  summaryParagraphs: [
    ...
    "My background in training, support, and business development lets me shift easily between technical stakeholders and business strategy with the economic buyer, adapting to each client's unique scenario and bringing in the right support when needed.",
  ...
  experience: [
    ...
    },
    {
      ...
      description: "Defence, State and Federal Government, Utilies, Higher Education, and Large Enterprise",
      responsibilities: [
