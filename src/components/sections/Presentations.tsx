      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {profileData.presentations.map((pres, idx) => (
            ...
            >
              <Card className="h-full flex flex-col overflow-hidden border-border/40 hover:border-red-500/30 transition-all group">
                ...
                <CardContent className="pt-6 flex-grow space-y-2">
                  ...
                  <h3 className="text-lg font-bold leading-tight group-hover:text-red-600 transition-colors line-clamp-2">
                    {pres.title}
                  </h3>
                </CardContent>
                <CardFooter className="pt-0 pb-6">
                  <Button variant="outline" size="sm" className="w-full gap-2 rounded-full border-red-200 dark:border-red-900/50 hover:bg-red-50 dark:hover:bg-red-900/20" asChild>
